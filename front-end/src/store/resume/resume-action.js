...
export const setCurrentCommunityResume = (resume) => ({ type: RESUME_ACTION_TYPES.SET_CURRENT_COMMUNITY_RESUME, payload: resume });
export const removeCommunityResume = () => ({ type: RESUME_ACTION_TYPES.SET_CURRENT_COMMUNITY_RESUME, payload: {} });
export const setCommunityResumeError = (error) => ({ type: RESUME_ACTION_TYPES.SET_COMMUNITY_RESUME_ERROR, payload: error });